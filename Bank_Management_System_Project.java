...
class Person extends gui {
    String name = new String("x");//Account holder's name.
    int Acno;//Account number
    int balance = 0;//Initial balance amount.
    String type;
    int interestRate;
...
public class gui {
    static int num = -1;  //Initial number of persons.
    

    public static void main(String[] args) {
        Person[] objarray = new Person[5]; //Array of objects.
        int[] account_num = new int[5];
        JFrame frame = new JFrame("Nirmayi's GUI window"); //Sets window name.
        try {
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);  //Should exit after clicking exit button.
        } catch (SecurityException e) {
            System.out.println(e.getMessage());
        }
        frame.setSize(600, 600);//Sets outer frame size.
        frame.setOpacity(1.0f);
        frame.getContentPane().setBackground(new Color(100,150,255));//Sets a background colour of light blue.
            ...
            JButton b9 = new JButton("Submit1");  //Adding buttons for various features.
            ...
            b9.setBounds(350, 100, 80, 20);// Setting bounds for various features.
            frame.add(b1);
            frame.add(b2);
            frame.add(b3);
            frame.add(b4);
            ...
            frame.add(b6);
            frame.add(b7);
            frame.add(b8);//Add all to frame.

            String str1 = new String(" Account Holder's name: ");
            ...
            String str6 = new String("Invalid A/c no.!");  //Input these strings from user.

            JLabel nam = new JLabel(str1);
            JLabel acno = new JLabel(str2);
            JLabel ToAC = new JLabel(str3);
            JLabel RoI = new JLabel(str4); //Give names to these labels.
            nam.setBounds(50, 50, 100, 30);
            acno.setBounds(50, 100, 100, 30);
            ToAC.setBounds(50, 150, 100, 30);
            RoI.setBounds(50, 200, 100, 30);  //Set bounds to the labels.
            frame.add(nam);
            frame.add(acno);
            frame.add(ToAC);
            frame.add(RoI);//Add the labels to the frame.

            JLabel heading = new JLabel("NIRMAYI.M.K BANK"); //Add heading.
            heading.setBounds(175, 0, 200, 50); //Set bounds for heading.
            heading.setFont(new Font("Monaco",Font.BOLD,20));
            frame.add(heading);//Add heading to the frame.
            ...
            l2 = new JLabel();
            l3 = new JLabel();
            l4 = new JLabel();  //Create 4 new labels.
            ...
            list1.setBounds(50, 150, 140, 400);
            frame.add(list1);
                ...
                b7.addActionListener(new ActionListener(){          //submit
                    public void actionPerformed(ActionEvent e2){
                        ...
                        if(found){
                            ...
                            l2.setText(str3 + objarray[i].type);
            ...
            public void actionPerformed(ActionEvent e){
                ...
                b7.addActionListener(new ActionListener(){          //submit
                    public void actionPerformed(ActionEvent e2){
                        ...
                        for (i = 0; i <= num; i++) {                  //search A/c FROM which amount transfer is to take place.
                            if (account_num[i] == u) {
                                found = true;
                                break;
                            }
                        ...
                        for (j = 0; j <= num; j++) {                 //search A/c to which the amount transfer is to take place.
                            if (account_num[j] == t) {
                                found2 = true;
                                break;
                            }
                    ...
                    public void actionPerformed(ActionEvent e2){
                        ...
                        if(found){
                            for(int j=0; j<=objarray[i].transactions; j++){
                                //TP1.setText(TP1.getText()+ "\n" + objarray[i].description[j] + objarray[i].amount[j]);
                                demolist.addElement(objarray[i].description[j] + objarray[i].amount[j]); 
                            }
